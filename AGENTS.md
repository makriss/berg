...
Berg is a fork of HyperDX/ClickStack, repurposed as a web UI for AWS S3 Tables
on top of an Athena query client and the Glue Data Catalog. It keeps HyperDX's
log/discover UX but targets analytical query workflows on S3 Tables instead of
telemetry on ClickHouse.
